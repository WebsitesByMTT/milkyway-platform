    ...
    <div className="h-full w-full text-white flex flex-col items-center justify-evenly">
      <div className="h-[50%] w-full flex flex-col items-center justify-evenly">
        <div className="flex items-center justify-center gap-[2vw] w-[70%]">
          <span className="inline-block bg-gradient-to-b from-[#ABDBF9] via-[#DBDED5] to-[#ABDBF9] bg-clip-text text-transparent text-[1.5vw] uppercase">
            Music
          </span>
          <div className="relative flex items-center w-[70%] h-[1.5vw]">
            <input
              type="range"
              min="0"
              max="100"
