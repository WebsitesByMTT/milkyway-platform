...
const Connector = ({ name, className }) => {
  return (
    <div className={className}>
      ...
      <div className="-mt-[5%] w-[100%] py-[4%] sm:py-[2%] flex px-8 md:px-0 items-center justify-center h-fit border-[0.2vw] border-[#2AD7FD] rounded-[2vw] bg-gradient-to-r from-[#011E4F] to-[#0143AC]">
